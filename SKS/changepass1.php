...
<body>
	...
	<div class="login-page">
	  <div class="form">
		<form class="login-form" method="post" action="changepass2.php">
		  帳號:<input type="text" placeholder="username" name="id_input"/>
		  舊密碼:<input type="password" placeholder="password" name="pass_input"/>
		  新密碼:<input type="password" placeholder="newpassword" name="newpass_input"/>
		  再次輸入新密碼:<input type="password" placeholder="newpassword" name="newpass_input2"/>
		  <br><br>
