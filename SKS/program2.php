...
//header("Refresh:0; url=program2.php");
?>
...
<table style="width: 600px; height: 225px" class="style1">
	...
	<tr>
		<td class="style4" colspan="2"><a href="author_edit.php?b=<?php echo $id ?>">資料修改</a></td>
		<td class="style4" colspan="2"><a class="various3" href="loginedit.php">帳密修改</a></td>
	</tr>
	</table>
