...
$sql="SELECT * FROM rad_day WHERE rad_author='$rt_author' ORDER BY rad_time_broadcast, rad_date_broadcast ASC";
...
$weekday2=array("星期日","星期一","星期二","星期三","星期四","星期五","星期六");
 ...
 ?>		
 			<td bgcolor="#F1F1F1"><?php echo $record1['rad_date_broadcast']?><br><a href=show_list_all.php?a=<?php echo $record1['rad_sn'].">".$record1['rad_title']."</a><br>".$record1['rad_time_broadcast']?></td>
   	...
   	<?php
        ...
        <td bgcolor="#F1F1F1"><?php echo $record1['rad_date_broadcast']?><br><a href=show_list_all.php?a=<?php echo $record1['rad_sn'].">".$record1['rad_title']."</a><br>".$record1['rad_time_broadcast']?>
       </td>
		<?php
	}
